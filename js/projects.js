...
$(document).ready(() => {
    ...
    $('#projects-carousel').on('slide.bs.carousel', function (event) {
        if(event.to === 0) {
            ...
            link.setAttribute('href','https://lamke-weather-application.herokuapp.com/')
        }
        if(event.to === 1) {
            ...
            link.setAttribute('href','https://lamke-notes.netlify.app/')
        }
        if(event.to === 2) {
            ...
            link.setAttribute('href','https://lamke-todo.netlify.app/')
        }
        if(event.to === 3) {
            ...
            link.setAttribute('href','https://lamke-hangman.netlify.app/') 
        }
        if(event.to === 4) {
            ...
            link.setAttribute('href','https://recipe-app-jg.netlify.app/')
        }
      })
})